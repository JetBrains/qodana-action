...
- Groovy – `build.gradle`
  ...
  ```groovy
  plugins {
      id "org.jetbrains.qodana" version "2026.2.0-SNAPSHOT"
  }
...
There's **no need to cherry-pick** any commits to any branch in the repository as it shall be done automatically (e.g., v2026.2.0 release would trigger v2026.2 branch update).
